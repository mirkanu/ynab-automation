...
- [ ] **DATA-05**: Existing activity log entries survive the rollback migration with no data loss
- [ ] **DATA-06**: Existing settings (sender routing rules, currency routing rules, test mode, other Setting rows) survive the rollback migration
