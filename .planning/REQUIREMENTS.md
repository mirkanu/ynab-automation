...
- [x] **LEGAL-03**: `docs/LICENSE-AUDIT.md` enumerates every runtime dependency with its license, confirms zero GPL/LGPL/AGPL/MPL/copyleft in the runtime tree, and notes attribution requirements
- [x] **POLISH-01**: `README.md` has a "Features" section showcasing three screenshots (dashboard, settings, activity log) with short blurbs; wizard install screenshots demoted to a collapsible `<details>` block
