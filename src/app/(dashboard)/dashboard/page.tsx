...
export default async function DashboardPage() {
  ...
  return (
    <div>
      ...
      {/* Two-panel grid: Email Automation (with Forwarding Address) + Currency */}
      <div style={{
        display: 'grid',
        ...
        {/* DASH-03: Email Automation panel + Forwarding Address */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          {/* Forwarding Address card — grouped with Email Automation (DASH-02 / FWD-01) */}
          {inboundEmail && (
            <div style={card}>
